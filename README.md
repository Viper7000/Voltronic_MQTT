...
Также вынес наружу 2 кнопки - в прошивке пока не использовал
Плата в сборе закрепляется на корпусе винтами как и версия 1.1
...
* $ \color{red}{\text{a}} $ - читается заряд батарей
